...
<footer class="container border-top text-center text-muted">
        <div class="row">
          <div class="col-12">
<small>
<a href="https://antibot.cloud/" target="_blank">Powered by AntiBot.Cloud</a> | Support: <a href="mailto:support@antibot.cloud?subject=AntiBot: '.$host.'" target="_blank">support@antibot.cloud</a> | Server Time: '.date('Y.m.d H:i:s', $ab_config['time']).' | Time: '.$exec_time.' Sec.</small>
</div>
</div>
      </footer>
<br />';
