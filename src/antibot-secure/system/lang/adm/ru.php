...
$pt['1 domain and any subdomains of it. 40 USD per year.'] = '1 домен и любые его поддомены. 40 USD в год.';
$pt['Without restrictions of domains, subdomains and without bindings to domains. 120 USD per year.'] = 'Без ограничений доменов, поддоменов и без привязок к доменам. 120 USD в год';
$pt['50% discount when renewing the service until the end of the current paid subscription.'] = 'Скидка 50% при продлении услуги до окончания текущей платной подписки.';
