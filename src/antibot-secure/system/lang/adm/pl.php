...
$pt['1 domain and any subdomains of it. 40 USD per year.'] = '1 domena i wszelkie jej subdomeny. 40 USD rocznie.';
$pt['Without restrictions of domains, subdomains and without bindings to domains. 120 USD per year.'] = 'Bez ograniczeń domen, subdomen i bez powiązań z domenami. 120 USD rocznie.';
$pt['50% discount when renewing the service until the end of the current paid subscription.'] = '50% rabatu przy odnowieniu usługi do końca aktualnie opłaconego abonamentu.';
...
// adm/top.php
$pt['Top queries'] = 'Najpopularniejsze zapytania';
$pt['Amount'] = 'Liczba';
