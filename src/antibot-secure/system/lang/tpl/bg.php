...
$pt['Loading page, please wait...'] = 'Страницата се зарежда, моля изчакайте...';
$pt['BLACK'] = 'ЧЕРЕН';
$pt['GRAY'] = 'СИВ';
$pt['PURPLE'] = 'ЛИЛАВО';
$pt['RED'] = 'ЧЕРВЕН';
...
$pt['GREEN'] = 'ЗЕЛЕНО';
$pt['BLUE'] = 'СИН';
$pt['If you are human, click on the button with the color most similar to this one:'] = 'Ако сте човек, кликнете върху бутона с цвета, най -близък до този:';
